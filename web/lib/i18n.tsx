...
const translations = {
  en: {
    ...
    // Landing page (new)
    "landing.socialProof": "Open source \u00b7 Self-hostable",
    "landing.heroTitle1": "Store and serve files with",
    "landing.heroTitle2": "Git as your backend",
    "landing.heroSubtitle": "Upload files to your GitHub repos and serve them through a fast API with CDN caching. No vendor lock-in. You own every byte.",
    "landing.viewOnGithub": "View on GitHub",
    "landing.whyTitle": "Why GitVault?",
    "landing.problemLabel": "The problem",
    "landing.solutionLabel": "The GitVault way",
    "landing.problem1": "S3, Cloudinary, R2 \u2014 yet another service to configure and pay",
    "landing.problem2": "Storage costs that grow unpredictably with your app",
    "landing.problem3": "Your files locked in proprietary platforms with vendor lock-in",
    "landing.problem4": "Complex SDKs, IAM policies, and permissions to set up",
    "landing.solution1": "Use GitHub repos you already have \u2014 free and unlimited",
    "landing.solution2": "No storage fees \u2014 GitHub handles it for you",
    "landing.solution3": "You own every file in your own repo \u2014 portable and transparent",
    "landing.solution4": "Simple REST API with key-based auth \u2014 one curl and done",
    "landing.howTitle": "How it works",
    "landing.howSubtitle": "Three steps to start serving files",
    "landing.step1Title": "Connect a repo",
    "landing.step1Desc": "Link an existing GitHub repository or create a new one. Install the GitHub App and you're ready.",
    "landing.step2Title": "Upload files",
    "landing.step2Desc": "Drag and drop through the dashboard or use the REST API. Each file is committed with SHA-256 deduplication.",
    "landing.step3Title": "Get your URL",
    "landing.step3Desc": "Every file gets a public CDN link or a private authenticated endpoint. Share or protect as needed.",
    "landing.featuresTitle": "Everything you need",
    "landing.featuresSubtitle": "Built for developers who want simple, reliable file hosting",
    "landing.feat1Title": "GitHub-backed storage",
    "landing.feat1Desc": "Every file is committed to a GitHub repo you control. Reliable, versioned, always yours.",
    "landing.feat2Title": "CDN-fast serving",
    "landing.feat2Desc": "Public files served from GitHub's CDN. Private files streamed securely through the API.",
    "landing.feat3Title": "Secure access",
    "landing.feat3Desc": "Firebase Auth with email, Google, or GitHub. Scoped API keys for granular control.",
    "landing.feat4Title": "REST API",
    "landing.feat4Desc": "Upload, list, and serve files programmatically. HTTP Basic auth with scoped API keys.",
    "landing.feat5Title": "Smart deduplication",
    "landing.feat5Desc": "SHA-256 content hashing prevents duplicates. Upload the same file twice, stored only once.",
    "landing.feat6Title": "Version history",
    "landing.feat6Desc": "Every upload is a Git commit. Roll back, audit, or diff your files with standard Git tools.",
    "landing.codeTitle": "Developer-first API",
    "landing.codeSubtitle": "Upload and serve files with a single HTTP request. Use API keys with scoped permissions for secure access.",
    "landing.pricingTitle": "Open source",
    "landing.pricingSubtitle": "Self-host it yourself or use our hosted version.",
    "landing.pricingFree": "Free to self-host",
    "landing.pricingIncl1": "Unlimited vaults",
    "landing.pricingIncl2": "Unlimited file uploads",
    "landing.pricingIncl3": "API access with scoped keys",
    "landing.pricingIncl4": "Public and private files",
    "landing.pricingIncl5": "Full source code on GitHub",
    "landing.ossTitle": "Open source and community driven",
    "landing.ossSubtitle": "GitVault is fully open source. Star us on GitHub, report issues, or contribute code.",
    "landing.ossStar": "Star on GitHub",
  ...
  es: {
    ...
    // Landing page (new)
    "landing.socialProof": "C\u00f3digo abierto \u00b7 Self-hostable",
    "landing.heroTitle1": "Almacena y sirve archivos con",
    "landing.heroTitle2": "Git como tu backend",
    "landing.heroSubtitle": "Sube archivos a tus repos de GitHub y s\u00edrvelos con una API r\u00e1pida con cach\u00e9 CDN. Sin vendor lock-in. T\u00fa eres due\u00f1o de cada byte.",
    "landing.viewOnGithub": "Ver en GitHub",
    "landing.whyTitle": "\u00bfPor qu\u00e9 GitVault?",
    "landing.problemLabel": "El problema",
    "landing.solutionLabel": "La soluci\u00f3n GitVault",
    "landing.problem1": "S3, Cloudinary, R2 \u2014 otro servicio m\u00e1s que configurar y pagar",
    "landing.problem2": "Costos de almacenamiento que crecen de forma impredecible",
    "landing.problem3": "Tus archivos atrapados en plataformas propietarias con vendor lock-in",
    "landing.problem4": "SDKs complejos, pol\u00edticas IAM y permisos que configurar",
    "landing.solution1": "Usa repos de GitHub que ya tienes \u2014 gratis e ilimitados",
    "landing.solution2": "Sin costos de almacenamiento \u2014 GitHub se encarga",
    "landing.solution3": "T\u00fa eres due\u00f1o de cada archivo en tu propio repo \u2014 portable y transparente",
    "landing.solution4": "API REST simple con auth por API key \u2014 un curl y listo",
    "landing.howTitle": "C\u00f3mo funciona",
    "landing.howSubtitle": "Tres pasos para empezar a servir archivos",
    "landing.step1Title": "Conecta un repo",
    "landing.step1Desc": "Conecta un repositorio de GitHub existente o crea uno nuevo. Instala la GitHub App y listo.",
    "landing.step2Title": "Sube archivos",
    "landing.step2Desc": "Arrastra archivos al panel o usa la API REST. Cada archivo se guarda con deduplicaci\u00f3n SHA-256.",
    "landing.step3Title": "Obt\u00e9n tu URL",
    "landing.step3Desc": "Cada archivo obtiene un enlace CDN p\u00fablico o un endpoint privado autenticado. Comparte o protege seg\u00fan necesites.",
    "landing.featuresTitle": "Todo lo que necesitas",
    "landing.featuresSubtitle": "Hecho para desarrolladores que quieren hosting de archivos simple y confiable",
    "landing.feat1Title": "Almacenamiento en GitHub",
    "landing.feat1Desc": "Cada archivo se guarda en un repo de GitHub que t\u00fa controlas. Confiable, versionado, siempre tuyo.",
    "landing.feat2Title": "Velocidad CDN",
    "landing.feat2Desc": "Archivos p\u00fablicos servidos desde el CDN de GitHub. Privados transmitidos de forma segura por la API.",
    "landing.feat3Title": "Acceso seguro",
    "landing.feat3Desc": "Firebase Auth con email, Google o GitHub. API keys con permisos espec\u00edficos para control granular.",
    "landing.feat4Title": "API REST",
    "landing.feat4Desc": "Sube, lista y sirve archivos de forma program\u00e1tica. Auth HTTP Basic con API keys con permisos.",
    "landing.feat5Title": "Deduplicaci\u00f3n inteligente",
    "landing.feat5Desc": "Hash SHA-256 previene duplicados. Sube el mismo archivo dos veces, se almacena solo una.",
    "landing.feat6Title": "Historial de versiones",
    "landing.feat6Desc": "Cada subida es un commit de Git. Revierte, audita o compara tus archivos con herramientas Git est\u00e1ndar.",
    "landing.codeTitle": "API pensada para desarrolladores",
    "landing.codeSubtitle": "Sube y sirve archivos con una sola petici\u00f3n HTTP. Usa API keys con permisos espec\u00edficos para acceso seguro.",
    "landing.pricingTitle": "C\u00f3digo abierto",
    "landing.pricingSubtitle": "Haz self-host o usa nuestra versi\u00f3n alojada.",
    "landing.pricingFree": "Gratis para self-host",
    "landing.pricingIncl1": "Vaults ilimitados",
    "landing.pricingIncl2": "Subidas ilimitadas",
    "landing.pricingIncl3": "Acceso API con keys con permisos",
    "landing.pricingIncl4": "Archivos p\u00fablicos y privados",
    "landing.pricingIncl5": "C\u00f3digo fuente completo en GitHub",
    "landing.ossTitle": "C\u00f3digo abierto e impulsado por la comunidad",
    "landing.ossSubtitle": "GitVault es completamente open source. Danos una estrella en GitHub, reporta problemas o contribuye c\u00f3digo.",
    "landing.ossStar": "Estrella en GitHub",
