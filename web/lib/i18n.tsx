...
const translations = {
  en: {
    ...
    // Landing page (new)
    "landing.socialProof": "Open source \u00b7 Free forever",
    "landing.heroTitle1": "Store and serve files with",
    "landing.heroTitle2": "Git as your backend",
    "landing.heroSubtitle": "Upload files to your GitHub repos and serve them through a fast API with CDN caching. Zero storage costs. You own every byte.",
    ...
    "landing.solution2": "Zero cost forever \u2014 GitHub handles the storage",
    ...
    "landing.pricingSubtitle": "No credit card. No hidden fees. No surprises.",
    "landing.pricingFree": "Free forever",
    ...
    "landing.pricingIncl5": "Community support",
  ...
  es: {
    ...
    // Landing page (new)
    "landing.socialProof": "C\u00f3digo abierto \u00b7 Gratis para siempre",
    "landing.heroTitle1": "Almacena y sirve archivos con",
    "landing.heroTitle2": "Git como tu backend",
    "landing.heroSubtitle": "Sube archivos a tus repos de GitHub y s\u00edrvelos con una API r\u00e1pida con cach\u00e9 CDN. Cero costos de almacenamiento. T\u00fa eres due\u00f1o de cada byte.",
    ...
    "landing.solution2": "Cero costo para siempre \u2014 GitHub maneja el almacenamiento",
    ...
    "landing.pricingTitle": "Precio simple",
    "landing.pricingSubtitle": "Sin tarjeta. Sin costos ocultos. Sin sorpresas.",
    "landing.pricingFree": "Gratis para siempre",
    ...
    "landing.pricingIncl5": "Soporte de la comunidad",
